...
class PlayerController {
  ...
  constructor(
    ...
    this._playerWrapper = CreateSphere('player-wrapper', { diameter: 1 });
    this._playerWrapper.position = new Vector3(0, this._characterHeight/2, -10);

    this._playerWrapper.physicsImpostor = new PhysicsImpostor(this._playerWrapper, PhysicsImpostor.SphereImpostor, { mass: 50, });
  ...
  _calculateMovement() {
    ...
    this._scene.registerBeforeRender(() => {
      ...
      const currentVelocity = this._playerWrapper.physicsImpostor.getLinearVelocity();
